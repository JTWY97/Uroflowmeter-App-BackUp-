...
class Firebase_LoginScreen(Screen, EventDispatcher):
	...
	def log_out(self):
		...
		self.ids.DoctorLogin.ids.User_Doctor.text = '' 
		self.ids.DoctorLogin.ids.Password_Doctor.text = '' 
		
	def on_login_success(self,  login_success_boolean): #DoctorHomePage,
	...
	def sign_out(self):
		...
		self.ids.ScreenM.current = 'Welcome'
		toast("Signed out")
...
class HomePage_Patient(Screen):
	pass

ScreenM = ScreenManager()

ScreenM.add_widget(Welcome_Page(name='Welcome'))
ScreenM.add_widget(Doctor_LogIn(name='DoctorLogin'))
ScreenM.add_widget(Firebase_LoginScreen(name='FirebaseLoginScreen'))
ScreenM.add_widget(Patient_LogIn(name='PatientLogin'))
ScreenM.add_widget(HomePage_Doctor(name='DoctorHomePage'))
ScreenM.add_widget(HomePage_Patient(name='PatientHomePage'))
...
class HomePagePatient(MDApp):
	...
	def build(self):
		...
		screen = Builder.load_file('LogInCombined.kv')
		return screen
