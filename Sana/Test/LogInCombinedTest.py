...
from MainPage_Patient import HomePagePatient
...
class FirebaseLoginScreen(Screen, EventDispatcher):
    ...
    def log_out(self):
        ...
        # Clear text fields
        self.ids.LogInScreen_Doctor.ids.User_Doctor.text = '' 
        self.ids.LogInScreen_Doctor.ids.Password_Doctor.text = '' 
        self.ids.LogInScreen_Patient.ids.User_Patient.text = '' 
        self.ids.LogInScreen_Patient.ids.Password_Patient.text = ''

    def on_login_success(self, HomePagePatient, login_success_boolean):
