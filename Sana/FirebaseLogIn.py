...
Builder.load_file(folder + "/Patient_LogIn.kv")
Builder.load_file(folder + "/Doctor_LogIn.kv")
Builder.load_file(folder + "/WelcomePage.kv")
Builder.load_file(folder + "/FirebaseLogin_Doctor.kv")
...
class Firebase_LoginScreen_Patient(Patient_LogIn, EventDispatcher):
	...
	# 	self.ids.Password_Pateint.text = ''
		
	# def on_login_success(self,  PatientHomePage, login_success_boolean):
